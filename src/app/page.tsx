    ...
    <div className="flex flex-col items-center px-4 md:px-16 bg-[#252B42] overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-[40px] mt-[104px]">
        ...
        <div className="flex flex-wrap justify-center mt-[80px] gap-[30px] mb-[80px]">
          ...
          <div className="bg-white text-black p-[35px] rounded-lg shadow-md w-full max-w-[328px] transition-transform duration-300 hover:scale-125">
          ...
          <div className="bg-[#35A6F0] text-white p-[35px] rounded-lg shadow-md w-full max-w-[328px] transition-transform duration-300 hover:scale-125">
